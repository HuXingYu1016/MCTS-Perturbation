...
class AdversaryNet(nn.Module):
    ...
    def __init__(self, state_dim, alpha, hidden_size=128):
        super().__init__()
        self.fc1 = nn.Linear(state_dim, hidden_size)
...
class Agent:
    def __init__(self, state_dim, action_dim, action_numb, alpha):
        ...
        self.adversary = AdversaryNet(state_dim, alpha).to(device)
    ...
    def apply_adversarial_perturbation(self, state):
